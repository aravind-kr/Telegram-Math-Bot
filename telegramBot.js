...
module.exports = class TelegramBot {
    ...
    constructor(botConfig, baseUrl) {
        ...
        this._telegramApiUrl =
            'https://api.telegram.org/bot' + botConfig.telegramToken
    }

    start(responseCallback, errCallback) {
        // https://core.telegram.org/bots/api#setwebhook
        request.post(
            this._telegramApiUrl + '/setWebhook',
            {
                json: {
            ...
            function(error, response, body) {
                ...
                if (response.statusCode != 200) {
                    ...
                    if (errCallback) {
                        errCallback(
                            'Error status code while setWebhook ' + body
                        )
                    }
                    return
                }
    ...
    reply(msg) {
        ...
        request.post(
            this._telegramApiUrl + '/sendMessage',
            {
                json: msg,
            },
            function(error, response, body) {
